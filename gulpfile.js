...
function copyFancyboxStyles() {
  return src('node_modules/@fancyapps/ui/dist/fancybox/fancybox.css')
    .pipe(dest(`${PATH_TO_DIST}styles/vendor/`));
}

export { copyFancyboxStyles };
